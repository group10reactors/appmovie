...
export default function Contact() {
    ...
    <label className="content" for="content">Content: </label><br /><textarea className="message_content" name="content" rows="10" placeholder="Enter the message content"></textarea>
